      ...
      with tf.compat.v2.summary.record_if(
        ...
        for _ in range(global_step.value(), train_steps,
          ...
          if global_step.value() - logged_step >= 100:
            ...
            percentage = int((int(global_step.value())/train_steps)*100)
            latest_iteration.text('Step {} per-step time {:.3f}s | Completion Percentage: {}%'.format(
                global_step.value(), (time_taken / num_steps_per_iteration), percentage))
